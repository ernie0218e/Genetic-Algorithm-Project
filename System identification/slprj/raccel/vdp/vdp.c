...
. x1_IC ; rtX . bxm4duvtnu = rtP . x2_IC ; } void MdlStart ( void ) { { void
...
} } void MdlOutputs ( int_T tid ) { rtB . dd2tkjygng = rtX . gq0u3r51ae ; rtY
. knrqyxbhzu = rtB . dd2tkjygng ; rtB . hlljur0dk4 = rtX . bxm4duvtnu ; rtY .
moq0w12ulw = rtB . hlljur0dk4 ; rtB . orz1zixoeg = ( 1.0 - rtB . dd2tkjygng *
rtB . dd2tkjygng ) * rtB . hlljur0dk4 ; rtB . lcixq30vmz = rtP . Mu_Gain *
rtB . orz1zixoeg ; rtB . jre4cphv4k = rtB . lcixq30vmz - rtB . dd2tkjygng ;
UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid ) { UNUSED_PARAMETER
( tid ) ; } void MdlDerivatives ( void ) { XDot * _rtXdot ; _rtXdot = ( (
XDot * ) ssGetdX ( rtS ) ) ; _rtXdot -> gq0u3r51ae = rtB . hlljur0dk4 ;
_rtXdot -> bxm4duvtnu = rtB . jre4cphv4k ; } void MdlProjection ( void ) { }
void MdlTerminate ( void ) { rtwOSigstreamManagerSaveDatasetsToMatFile (
...
1 ) ; ssSetNumBlocks ( rtS , 9 ) ; ssSetNumBlockIO ( rtS , 5 ) ;
...
2453801059U ) ; ssSetChecksumVal ( rtS , 1 , 1349397466U ) ; ssSetChecksumVal
( rtS , 2 , 994031874U ) ; ssSetChecksumVal ( rtS , 3 , 1253130894U ) ; }
...
rtB . orz1zixoeg = 0.0 ; rtB . lcixq30vmz = 0.0 ; rtB . jre4cphv4k = 0.0 ; }
} { ssSetY ( rtS , & rtY ) ; rtY . knrqyxbhzu = 0.0 ; rtY . moq0w12ulw = 0.0
; } ssSetDefaultParam ( rtS , ( real_T * ) & rtP ) ; { real_T * x = ( real_T
* ) & rtX ; ssSetContStates ( rtS , x ) ; ( void ) memset ( ( void * ) x , 0
, sizeof ( X ) ) ; } { void * dwork = ( void * ) & rtDW ; ssSetRootDWork (
...
ssSetChecksumVal ( rtS , 0 , 2453801059U ) ; ssSetChecksumVal ( rtS , 1 ,
1349397466U ) ; ssSetChecksumVal ( rtS , 2 , 994031874U ) ; ssSetChecksumVal
( rtS , 3 , 1253130894U ) ; { static const sysRanDType rtAlwaysEnabled =
