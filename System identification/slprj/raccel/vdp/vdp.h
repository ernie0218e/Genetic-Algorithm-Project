...
#endif
typedef struct { real_T dd2tkjygng ; real_T hlljur0dk4 ; real_T orz1zixoeg ;
real_T lcixq30vmz ; real_T jre4cphv4k ; } B ; typedef struct { struct { void
* LoggedData ; } abh5bjzoxu ; } DW ; typedef struct { real_T gq0u3r51ae ;
real_T bxm4duvtnu ; } X ; typedef struct { real_T gq0u3r51ae ; real_T
bxm4duvtnu ; } XDot ; typedef struct { boolean_T gq0u3r51ae ; boolean_T
bxm4duvtnu ; } XDis ; typedef struct { real_T gq0u3r51ae ; real_T bxm4duvtnu
; } CStateAbsTol ; typedef struct { real_T knrqyxbhzu ; real_T moq0w12ulw ; }
ExtY ; typedef struct { rtwCAPI_ModelMappingInfo mmi ; } DataMapInfo ; struct
P_ { real_T x1_IC ; real_T x2_IC ; real_T Mu_Gain ; } ; extern const char *
