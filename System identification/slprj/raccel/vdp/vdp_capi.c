...
"vdp/Mu" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 1 , 0 ,
TARGET_STRING ( "vdp/x1" ) , TARGET_STRING ( "x1" ) , 0 , 0 , 0 , 0 , 0 } , {
2 , 0 , TARGET_STRING ( "vdp/x2" ) , TARGET_STRING ( "x2" ) , 0 , 0 , 0 , 0 ,
0 } , { 3 , 0 , TARGET_STRING ( "vdp/Product" ) , TARGET_STRING ( "" ) , 0 ,
0 , 0 , 0 , 0 } , { 4 , 0 , TARGET_STRING ( "vdp/Sum" ) , TARGET_STRING ( ""
) , 0 , 0 , 0 , 0 , 0 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 }
} ; static const rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 5 ,
TARGET_STRING ( "vdp/Mu" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 6 ,
TARGET_STRING ( "vdp/x1" ) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0
} , { 7 , TARGET_STRING ( "vdp/x2" ) , TARGET_STRING ( "InitialCondition" ) ,
0 , 0 , 0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 } } ; static const
rtwCAPI_ModelParameters rtModelParameters [ ] = { { 0 , ( NULL ) , 0 , 0 , 0
} } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . lcixq30vmz , & rtB . dd2tkjygng ,
& rtB . hlljur0dk4 , & rtB . orz1zixoeg , & rtB . jre4cphv4k , & rtP .
Mu_Gain , & rtP . x1_IC , & rtP . x2_IC , } ; static int32_T *
...
, rtSampleTimeMap , rtDimensionArray } , "float" , { 2453801059U ,
1349397466U , 994031874U , 1253130894U } , ( NULL ) , 0 , 0 } ; const
